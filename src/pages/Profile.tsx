...
import CoverOne from '../images/cover/Frame 10.png';
...
const Profile = () => {
  ...
  const [totalAstrologers, setTotalAstrologers] = useState([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setTotalCredit(total_credit.data.total);
        setTotalUsers(total_users_data.data.total);
        setTotalAstrologers(total_astrologers_data.data.total);
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto mt-4.5 mb-5.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
              ...
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                ...
                <span className="text-sm">Astrologers</span>
              </div>
